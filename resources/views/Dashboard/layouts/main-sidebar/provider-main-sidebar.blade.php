        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('provider.providerApproved') }}"> قائمة الحجوزات ف انتظار الدفع</a></li>
                    ...
                    <li><a class="slide-item" href="{{ route('WatingConfirm.requests') }}">  الرحلات المدفوعة ف انتظار التاكيد</a></li>
