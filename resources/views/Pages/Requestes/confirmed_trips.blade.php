        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-white">قائمة الرحلات المقبولة</h3>
                    ...
                    <table id="datatable" class="table table-hover" style="width:100%">
                        ...
                        @foreach($trips as $trip)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if(optional($trip)->image)
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#paymentModal-{{ $trip->id }}">
                                            <i class="fas fa-receipt ml-1"></i> عرض الإيصال
                                        </button>

                                        <!-- Modal for Payment Receipt -->
                                        <div class="modal fade" id="paymentModal-{{ $trip->id }}" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="paymentModalLabel">
                                                            <i class="fas fa-file-invoice-dollar ml-2"></i> إيصال الدفع
                                                        </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        <img src="{{ Storage::url($trip->image) }}" class="img-fluid rounded shadow" alt="إيصال الدفع" style="max-height: 70vh;">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                                                            <i class="fas fa-times ml-1"></i> إغلاق
                                                        </button>
                                                        <a href="{{ Storage::url($trip->image) }}" download class="btn btn-primary">
